...
class CategoryResults extends Component {
  constructor(props) {
    ...
    this.state = {
      result: [
        { 'url' : '1', 'name': 'Aceites' }, { 'url' : '2', 'name': 'Adivitivos y materias primas' }, { 'url' : '3', 'name': 'Aguas y aguas gasificadas' }, { 'url' : '4', 'name': 'Alfajores' }, { 'url' : '5', 'name': 'Algas' },
        { 'url' : '6', 'name': 'Alimentos para lactantes (0-12 meses)' }, { 'url' : '7', 'name': 'Alimentos para niños en primera infancia (1-3 años)' },
        ...
        { 'url' : '28', 'name': 'Cremas' }, { 'url' : '29', 'name': 'Dulces de leche ' }, { 'url' : '30', 'name': 'Edulcorantes de mesa' }, { 'url' : '31', 'name': 'Fiambres y embutidos' }, { 'url' : '32', 'name': 'Frutas secas y desecadas' },
        { 'url' : '33', 'name': 'Galletas y galletitas' }, { 'url' : '34', 'name': 'Golosinas' }, { 'url' : '35', 'name': 'Hortalizas, verduras y hongos ' }, { 'url' : '36', 'name': 'Leches' }, { 'url' : '37', 'name': 'Leches fermentadas' },
        { 'url' : '38', 'name': 'Legumbres' }, { 'url' : '39', 'name': 'Leudantes' }, { 'url' : '40', 'name': 'Mantecas' }, { 'url' : '41', 'name': 'Margarinas' }, { 'url' : '42', 'name': 'Mermeladas, confituras y dulces' },
        { 'url' : '43', 'name': 'Panes y productos de panaderia' }, { 'url' : '44', 'name': 'Pastas'}, { 'url' : '45', 'name':  'Postres, flanes y helados listos para consumir'},
        { 'url' : '46', 'name': 'Productos de confiteria' }, { 'url' : '47', 'name': 'Productos de reposteria' }, { 'url' : '48', 'name': 'Productos para preparar postres, flanes, gelatinas y helados' },
        { 'url' : '49', 'name': 'Quesos' }, { 'url' : '50', 'name': 'Sales' }, { 'url' : '51', 'name': 'Salsas y aderezos' },
        { 'url' : '52', 'name': 'Snacks' }, { 'url' : '53', 'name': 'Suplementos dietarios ' }, { 'url' : '54', 'name': 'Tes e infusiones ' }, { 'url' : '55', 'name': 'Yerba mate '}, {'url': '56', 'name': 'Yogures' }
      ],
      renderedData: '',
      received: false,
      page: 1
    ...
    return (
      <div className='Main'>
        ...
        <div className="container">
          ...
          <div className='quantity'>Pagina {page} | Mostrando {prodslength * (page - 1)} - {prodslength * page} de {length} categorías</div>
